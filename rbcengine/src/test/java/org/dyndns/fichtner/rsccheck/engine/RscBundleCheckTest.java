...
public class RscBundleCheckTest extends TestCase {
	...
	private static RscBundleCheck createRscBundleCheck(String string)
		...
		for (RscBundleReader rscBundleReader : Collections
				.singletonList(new RscBundleReaderFile(
						new StringReader(string), "<identifier>"))) {
			context.addRscBundleReader(rscBundleReader);
		}
